...
{
    public partial class ucCRUDPagoSolPago : ucBaseForm2015
    {
        #region Constantes
        ...
        private const string CAMPO_PROVEEDORNROFACTURA = "ProveedorNroFactura";
        private const string CAMPO_PROVEEDORFECFACTURA = "ProveedorFecFactura";
        ...
        private const string CAMPO_NROTRANSACCION = "NroTransaccion";
        private const string CAMPO_CODREFERENCIA = "CodReferencia";
        private const string CAMPO_FECHACARGA = "FechaCarga";
        /*Cheque*/
        ...
        private List<PagoSolPagoTypeAll> lPagos;
        #endregion Variables Globales

        #region Método de Inicio
        public ucCRUDPagoSolPago()
        {
            InitializeComponent();
        }

        public ucCRUDPagoSolPago(string Titulo = "Sin Título", BerkeDBEntities dbContext = null)
        {
            InitializeComponent();
            ...
            lPagos = new List<PagoSolPagoTypeAll>();

            lPagos = (from lista in this.DBContext.GetListaPagoProveedores(this.UsuarioID, String.Empty)
                      select new PagoSolPagoTypeAll
                      {
                          PagoProveedorID = lista.PagoProveedorID, //ID de Pago
                          Origen = lista.Origen,
                          ProveedorID = lista.ProveedorID,
                          ProveedorNombre = lista.ProveedorNombre,
                          ProveedorNroFactura = lista.ProveedorNroFactura,
                          ProveedorFecFactura = lista.ProveedorFecFactura,
                          ...
                          NroTransaccion = lista.NroTransaccion,
                          CodReferencia = lista.CodReferencia,
                          FechaCarga = lista.FechaCarga,
                          /*Cheque*/
            ...
            var query = (from item in lPagos
                         select new PagoSolPagoTypeCab
                         {
                             //Cabecera
                             PagoProveedorID = item.PagoProveedorID, //ID de Pago
                             Origen = item.Origen,
                             ProveedorID = item.ProveedorID,
                             ProveedorNombre = item.ProveedorNombre,
                             ProveedorNroFactura = item.ProveedorNroFactura,
                             ProveedorFecFactura = item.ProveedorFecFactura,
                         ...
                         .GroupBy(x => new { x.PagoProveedorID }).Select(g => g.First()).ToList();
            ...
            this.SetFilter(CAMPO_PROVEEDORID, "Prov. ID", false);
            this.SetFilter(CAMPO_PROVEEDORNOMBRE, "Prov. Nomb.");
            this.SetFilter(CAMPO_PROVEEDORNROFACTURA, "N° Fact. Prov.");
            this.SetFilter(CAMPO_PROVEEDORFECFACTURA, "Fec. Fact. Prov.");
            ...
            this.SetFilter(CAMPO_NROTRANSACCION, "N° Transacción");
            this.SetFilter(CAMPO_CODREFERENCIA, "Cod. Referencia");
            ///*Cheque*/
            ...
            if (fPickCuentaDeposito != null)
            {
                ...
                var query = (from cb in this.DBContext.cb_cuentabanco
                             join mo in this.DBContext.Moneda
                                on cb.cb_monedaid equals mo.ID
        ...
        private void fPickCuentaDeposito_AceptarFiltrarClick(object sender, EventArgs e)
        {
            ...
            this.txtCuentaMoneda.Text = fPickCuentaDeposito.GetValor(CAMPO_MONEDAABREV).ToString();
        ...
        private void tSBSolicitudCab_AceptarClick(object sender, EventArgs e)
        {
            ...
            if (filterType == FILTRO_PROVEEDOR)
            {
                ...
                {
                    fSelSolxProv = new FSelSolicPorProveedor(this.DBContext, "Selección de Documentos para Pago");
            ...
            else
            {
                if (fPickSolicitudCab == null)
                {
                    ...
                    if (this.cbCampoFiltro.SelectedIndex == 0)
                    {
                        ...
                        fPickSolicitudCab.SetExplicitToolTipIDTextBox("N° o Fecha de Factura, Proveedor, Referencia u Observación");
        ...
        private void fPickSolicitudCab_FiltrarClick(object sender, EventArgs e)
        {
            ...
            #region Pick SolicitudCab
                if (fPickSolicitudCab != null)
                {
                    ...
                    var query = (from data in this.DBContext.GetDocumentoAPagar(filterType,
                                                                                valorInt,
                                                                                valorAlfa)
            ...
            if (this.GetFilterType() == FILTRO_SOLICITUD)
            {
                ...
                var query = (from spc in this.DBContext.spc_solicitudpagocab
                             ...
                             join prov in this.DBContext.pr_proveedor 
                                on spd.spd_proveedorid equals prov.pr_proveedorid into prov_spd
                                from prov in prov_spd.DefaultIfEmpty()
                             join mon in this.DBContext.Moneda
                                ...
                                select new
                                {
                                    ...
                                    NombreProveerdor = prov.pr_nombre,
        ...
        private void tbbImprimir_Click_1(object sender, EventArgs e)
        {
            if (this.FormEditStatus == BROWSE)
            {
                ...
                try
                {
                    ...
                    PagoSolPagoTypeAll psa = lPagos.First(a => a.PagoProveedorID == PagoProveedorID);
                    ...
                    reportDS = this.DBContext.RepOrdenPagoxID(PagoProveedorID).ToList();
        ...
        protected override void FilterEntity(string where = "", object[] filterParams = null)
        {
            try
            {
                ...
                lPagos = (from lista in this.DBContext.GetListaPagoProveedores(this.UsuarioID, filtro)
                             select new PagoSolPagoTypeAll
                             {
                                 PagoProveedorID = lista.PagoProveedorID, //ID de Pago
                                 Origen = lista.Origen,
        ...
        protected override void FormatearGrilla()
        {
            ...
            this.dgvListadoABM.Columns[CAMPO_PAGOPROVEEDORID].HeaderText = "Pago ID";
            this.dgvListadoABM.Columns[CAMPO_PAGOPROVEEDORID].Width = 60;
            ...
            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNROFACTURA].HeaderText = "N° Factura";
            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNROFACTURA].Width = 100;
            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNROFACTURA].DisplayIndex = displayIndex;
            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNROFACTURA].Visible = true;
            displayIndex++;

            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNOMBRE].HeaderText = "Proveedor";
            this.dgvListadoABM.Columns[CAMPO_PROVEEDORNOMBRE].Width = 200;
        ...
        protected override void Editable(bool editar)
        {
            if (this.FormEditStatus == EDIT)
            {
                ...
                this.txtFechaDeposito.ReadOnly = false; //true;
                this.tSBBancoDeposito.Editable = true; //false;
                this.tSBCuentaDeposito.Editable = true; //false;
                ...
                this.dtpFechaDeposito.Enabled = true; //false;
                ...
                this.txtNroTransaccion.ReadOnly = false;
                this.txtNroTransaccion.BackColor = SystemColors.Window;
                this.txtCodReferencia.ReadOnly = false;
                this.txtCodReferencia.BackColor = SystemColors.Window;
            ...
            else
            {
                ...
                this.txtNroTransaccion.ReadOnly = editar;
                this.txtNroTransaccion.BackColor = SystemColors.Window;
                this.txtCodReferencia.ReadOnly = editar;
                this.txtCodReferencia.BackColor = SystemColors.Window;
        ...
        private void limpiarDatos()
        {
            ...
            this.txtFechaCarga.Text = "";
            this.txtCuentaMoneda.Text = "";
        ...
        private void CargarPago(DataGridViewRow row)
        {
            ...
            try
            {
                ...
                this.txtPagoID.Text = row.Cells[CAMPO_PAGOPROVEEDORID].Value.ToString();
                ...
                this.txtNroFactura.Text = row.Cells[CAMPO_PROVEEDORNROFACTURA].Value != null ? row.Cells[CAMPO_PROVEEDORNROFACTURA].Value.ToString() : "";
                this.txtFecFactura.Text = row.Cells[CAMPO_PROVEEDORFECFACTURA].Value != null
                                            ? Convert.ToDateTime(row.Cells[CAMPO_PROVEEDORFECFACTURA].Value).ToShortDateString() : "";
                ...
                if (row.Cells[CAMPO_PROVEEDORNOMBRE].Value != null)
                {
                    if (row.Cells[CAMPO_PROVEEDORNOMBRE].Value.ToString() == VARIOS_PROVEEDORES)
                    {
                        this.txtProveedorID.Text = VARIOS_PROVEEDORES;
                        this.txtProveedorID.Size = new Size(WIDTH_113, this.txtProveedorID.Size.Height);
                        this.txtProveedorNombre.Text = "";
                    ...
                    else
                    {
                        ...
                        this.txtProveedorNombre.Text = row.Cells[CAMPO_PROVEEDORNOMBRE].Value.ToString();
                    }
                }
                else
                {
                ...
                this.txtFechaCarga.Text = Convert.ToDateTime(row.Cells[CAMPO_FECHACARGA].Value).ToShortDateString();
                ...
                if (row.Cells[CAMPO_NROTRANSACCION].Value != null)
                    this.txtNroTransaccion.Text = row.Cells[CAMPO_NROTRANSACCION].Value.ToString();

                if (row.Cells[CAMPO_CODREFERENCIA].Value != null)
                    this.txtCodReferencia.Text = row.Cells[CAMPO_CODREFERENCIA].Value.ToString();
        ...
        private void GuardarRegistro()
        {
            ...
            {
                if (this.FormEditStatus == INSERT)
                    this.FilterEntity(CAMPO_PAGOPROVEEDORID + " = " + ps.ps_pagosolicitudid.ToString(), null);
        ...
        private void ucCRUDPagoSolPago_CRUDEvent(object sender, EventArgs e)
        {
            ...
            if (this.FormEditStatus == INSERT)
            {
                ...
                if (this.txtNroTransaccion.Text != "")
                    ps.ps_nrotransaccion = this.txtNroTransaccion.Text;
                else ps.ps_nrotransaccion = null;

                if (this.txtCodReferencia.Text != "")
                    ps.ps_codreferencia = this.txtCodReferencia.Text;
                else ps.ps_codreferencia = null;
        ...
        private ps_pagosolicitud guardarPago(BerkeDBEntities context = null)
        {
            ...
            if (this.FormEditStatus == EDIT)
            {
                ...
                if (this.txtCodReferencia.Text != "")
                    ps.ps_codreferencia = this.txtCodReferencia.Text;
                else ps.ps_codreferencia = this.txtCodReferencia.Text;
                #endregion Transferencia
        ...
        private void AnularPagoProveedor(int PagoProveedorID)
        {
            ...
            using (var context = new BerkeDBEntities())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    ...
                    {
                        dbContextTransaction.Rollback();
                        MessageBox.Show("Ocurrió un error al anular el movimiento. "
                                        + ex.Message + Environment.NewLine
                                        + ex.InnerException,
                                        "Error al anular",
                                        MessageBoxButtons.OK,

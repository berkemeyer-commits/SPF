...
{
    public partial class FRepListadoCotizacionesPorTramite : Form
    {
        #region Variables
        ...
        public const string TRAMITE = "(TramiteID = {0})";
        ...
        public FRepListadoCotizacionesPorTramite()
        {
            InitializeComponent();
        }

        public FRepListadoCotizacionesPorTramite(string titulo, BerkeDBEntities context = null)
        {
            InitializeComponent();
            this.Text = titulo;
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            string tramiteid = this.tSBTramite.KeyMember != String.Empty ? this.tSBTramite.KeyMember : String.Empty; ;

            string whereString = String.Empty;

            whereString += clienteid != String.Empty ? String.Format(CLIENTE, clienteid) : String.Empty;
            whereString += tramiteid != String.Empty ? String.Format(TRAMITE, tramiteid) : String.Empty;
            ...
            if (this.rbAl.Checked)
            {
                ...
                //whereFecha = String.Format(HASTA, fechaHasta);
            ...
            else if (this.rbRango.Checked)
            {
                ...
                //whereFecha = String.Format(RANGO, fechaDesde, fechaHasta);
            ...
            string path = @"Reportes\RepListadoCotizacionesPorTramite.rdlc";

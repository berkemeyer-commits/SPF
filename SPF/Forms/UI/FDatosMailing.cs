...
{
    public partial class FDatosMailing : Form
    {
        #region Variables
        ...
        public string Body
        {
            set { this.txtCuerpo.Text = value; }
            get { return this.txtCuerpo.Text; }
        }
        
        #endregion Propiedades

        public FDatosMailing()
        {
            InitializeComponent();
        }

        public FDatosMailing(BerkeDBEntities context)
        {
            InitializeComponent();

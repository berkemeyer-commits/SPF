...
namespace ModelEF6
{
    ...
    public partial class nc_notacreditocabecera
    {
        public nc_notacreditocabecera()
        {
            this.nd_notacreditodetalle = new ObservableListSource<nd_notacreditodetalle>();
        }
    
        public int nc_notacreditocabeceraid { get; set; }
        public Nullable<int> nc_timbradoid { get; set; }
        public System.DateTime nc_fechanotacredito { get; set; }
        ...
        public virtual me_motivoemision me_motivoemision { get; set; }
        public virtual Moneda Moneda { get; set; }
        public virtual ObservableListSource<nd_notacreditodetalle> nd_notacreditodetalle { get; set; }
    }
}
